...
export const workImages = [
    {   
        ...
        id: 0,
        type: 'SPA',
        description: 'Приложение обрабатывает звуковой поток с микрофона или звуковой карты и сопровождает цветовой индикацией. Простыми словами цветомузыка онлайн.',
